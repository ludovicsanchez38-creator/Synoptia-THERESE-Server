"""
THÉRÈSE v2 - Perplexity Provider

Perplexity API streaming implementation (OpenAI-compatible).
Recherche augmentée par IA via https://api.perplexity.ai.
"""
...
class PerplexityProvider(BaseProvider):
    """Perplexity API provider (OpenAI-compatible, recherche augmentée)."""
    ...
    async def stream(
        ...
        """Stream from Perplexity API with tool support."""
        ...
        except (httpx.RequestError, ConnectionError, ValueError, OSError) as e:
